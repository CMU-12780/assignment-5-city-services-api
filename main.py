...
from routers.traffic_signals import router as traffic_signals_router
...
app.include_router(traffic_signals_router, prefix="/api/traffic-signals", tags=["Traffic Signals"])
